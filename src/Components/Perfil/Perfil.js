...
import AgregarCentro from "../Centro/AgregarCentro";
    ...
    <>
      <div className="container">
        <div className="d-flex justify-content-between align-items-center">
          {!addCenter ? (
            <button className="btn-edit" onClick={addCenterHandler}>
              Agregar Centro
            </button>
          ) : (
            " "
        ...
        {!addCenter ? (
          ...
          <AgregarCentro button={addCenterHandler} />
        )}
      </div>
    </>
  );
